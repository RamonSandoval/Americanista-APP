...
class AperturaPartidos {
  ...
  factory AperturaPartidos.fromJson(String str) =>
      AperturaPartidos.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AperturaPartidos.fromMap(Map<String, dynamic> json) =>
      AperturaPartidos(
...
class Api {
  ...
  factory Api.fromMap(Map<String, dynamic> json) => Api(
        ...
        fixtures: List<Apertura22>.from(
            json["fixtures"].map((x) => Apertura22.fromMap(x))),
      );
...
class Apertura22 {
  ...
  factory Apertura22.fromJson(String str) =>
      Apertura22.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Apertura22.fromMap(Map<String, dynamic> json) => Apertura22(
...
enum Status { NOT_STARTED, TIME_TO_BE_DEFINED }
